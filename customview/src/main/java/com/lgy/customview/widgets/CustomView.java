...
public class CustomView extends AppCompatTextView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = getCustomSize(100, widthMeasureSpec, "width");
        int height = getCustomSize(100, heightMeasureSpec, "height");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(str, mRect.centerX(), mRect.centerY(), mPaint);
        canvas.save();
    ...
    private int getCustomSize(int width, int measureSpec, String str) {
        ...
        switch (measureMode) {
            ...
            case MeasureSpec.AT_MOST:
                ...
                backSize = measureSize > width ? measureSize : width;
